...
|---------|---------------|
| `v0.2.0` (current) | Yes |
| `v0.1.x` and earlier | No — upgrade to `v0.2.0` |
...
|--------|----------|---------|
| Skill content modified in transit (CDN or registry) | Tampering | `CHECKSUMS.md` SHA-256 per file; pinned `@v0.2.0` install |
...
The following controls are planned but not yet implemented for `v0.2.0`:
